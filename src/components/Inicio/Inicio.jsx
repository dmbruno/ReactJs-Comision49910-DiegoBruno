...
export const Inicio = () => {
    ...
    return (
        <div className="contenedor-menu px-4 py-4">
            <h1 className="titulo-menu text-4xl font-bold text-center py-4 font-mono">BIENVENIDOS A LA CUEVA</h1>
            <div className="contenedor">
                ...
                <Link to={"/menu/champagneEspumantes"} className="bg-yellow-200 px-4 py-2 rounded-lg shadow-lg hover:shadow-xl transition-shadow font-extrabold text-lg">Champagne y Espumantes</Link>
